...
>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      ...
      <p style="font-size: 30px; color: #696CFF; font-weight: 700;">Beriarti</p>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <!-- Forms & Tables -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Manajemen Penggalangan</span></li>
            <!-- Forms -->
            <!-- Tables -->
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form-layouts-vertical.html" class="menu-link">
                    <div data-i18n="Vertical Form">Restore</div>
                  </a>
                </li>
                <li class="menu-item">
