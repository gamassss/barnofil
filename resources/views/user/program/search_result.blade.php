...
<body class="bg-[#F7F7F7] font-rubik">
    <section class="bg-primer h-16 py-3 z-[100] fixed top-0 left-0 right-0 w-full mb-4">
        <div class="flex justify-start h-full container">
            ...
            <div class="container h-full lg:max-w-lg flex items-center">
                <h4 class="text-white font-semibold text-base">Hasil pencarian '{{ $result }}'</h4>
            </div>
        </div>
    </section>
    ...
    @else
        <section class="bg-white h-screen w-full pt-16">
            <div class="flex flex-col items-center h-full justify-center w-full py-4">
                <img src="{{ asset('img/icons/notfound-jar.svg') }}" alt="" class="w-40">
                <p class="text-[#4A4A4A] font-semibold text-base mt-4 my-3">Tidak ada program ditemukan</p>
                <p class="text-[#989898] text-xs text-center">Program dengan keyword '{{ $result }}' tidak ada
                </p>
            </div>
        </section>
    @endif
